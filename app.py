...
@app.route("/")
def index():
    return render_template("index.html",predicted_disease="ajnddjjdij")
...
def predict():
    if request.method == 'POST':
        ...
        if not symptoms:
            ...
            return render_template('index.html', message=message,predicted_disease="ajnddjjdij")
...
print(get_predicted_value([ "stomach_pain, acidity, ulcers_on_tongue, cough"]))
